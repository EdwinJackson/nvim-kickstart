...
require('lazy').setup({
  ...
  require 'kickstart.plugins.autoformat', -- I.E. Prettier
  require 'kickstart.plugins.autocomplete', -- Autocomplete plugin
  require 'kickstart.plugins.theme', -- tokyonight is the default
  require 'kickstart.plugins.mini', -- A bunch of plugins like surround and change-in
